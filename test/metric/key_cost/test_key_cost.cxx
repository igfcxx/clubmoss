...
namespace clubmoss::metric::test {
...
TEST_SUITE("Test metric::KeyCost") {
    ...
    const key_cost::Data EN_DATA(toml::parse(DATA_PATH));
    ...
    TEST_CASE("test metric::KeyCost::measure()") {
        const uz cost_1 = kc_metric.measure(layout::baselines::QWERTY);
        const uz cost_2 = kc_metric.measure(layout::baselines::DVORAK);
        CHECK(cost_1 > cost_2);
    }
